...
llvm-gcc -Os -fno-strict-aliasing -fPIC -W -Wall -Wno-unused -Wno-parentheses -pipe -m64 -fno-omit-frame-pointer -D_LITTLE_ENDIAN -D__sun_jdk -DNDEBUG -DARCH='"x86_64"' -Dx86_64 -D_ALLBSD_SOURCE -DRELEASE='"1.8.0"' -D_LARGEFILE64_SOURCE -D_GNU_SOURCE -D_REENTRANT -DMACOSX -D_LP64=1 -I./class_headers -I./src_solaris_javavm_export -I./src_share_javavm_export -I. -I./MUSCLE -I./src_share_native_common -I./src_solaris_native_common -c -o x86_64/pcsc.o pcsc.c
